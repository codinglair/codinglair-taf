...
class McpSecurityTest {
  ...
  class AuthorizationPolicy {
    ...
    void denyOverridesAllow() {
      var allow =
          rule("role-allow", PolicyRule.Effect.ALLOW, Set.of("developer"), Set.of("*"), false);
      var environmentDeny =
          new PolicyRule(
              "production-deny",
      ...
      var decision =
          new AuthorizationPolicyEngine(List.of(allow, environmentDeny)).decide(context("execute"));
  ...
  class ApprovalDecisions {
    ...
    void preventsDecisionReplacement() {
      ...
      assertThrows(
          IllegalStateException.class, () -> approvals.decide(request.id(), APPROVER, false));
    ...
    void requiresSeparateHumanApprover() {
      ...
      assertThrows(
          IllegalArgumentException.class, () -> approvals.decide(request.id(), CALLER, true));
      assertThrows(
  ...
  class TransportNeutralEnforcement {
    ...
    void denialHasNoSideEffect(Transport transport) {
      ...
      var result =
          fixture.service.enforce(
              request(transport, context("scaffold"), null), () -> sideEffects.incrementAndGet());
    ...
    void approvalCannotBeBypassed(Transport transport) {
      var fixture =
          fixture(
              List.of(
                  rule("write", PolicyRule.Effect.ALLOW, Set.of("developer"), Set.of("*"), true)));
      var sideEffects = new AtomicInteger();
    ...
    void excessiveElementsAreRejected() {
      ...
      var result =
          fixture.service.enforce(
              request(Transport.INTERNAL, context("report"), null, List.of("one", "two", "three")),
              () -> sideEffects.incrementAndGet());
      ...
      var fixture =
          fixture(
              List.of(
                  rule("write", PolicyRule.Effect.ALLOW, Set.of("developer"), Set.of("*"), true)));
      var approval =
          fixture.approvals.request(context("scaffold"), "operation", Duration.ofMinutes(5));
  ...
  private static EnforcementRequest request(
      Transport transport, AuthorizationContext context, String approvalId, Object input) {
    return new EnforcementRequest("corr-1", transport, context, "operation", approvalId, input);
  }
