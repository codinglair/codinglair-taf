...
public record TestNgAttemptResult(
  ...
  public TestNgAttemptResult {
    ...
    if ((status == Status.FAILED || status == Status.CONFIGURATION_FAILED)
  ...
  public TestNgAttemptResult(
    ...
    this(
        ...
        status == Status.FAILED
                ...
                || status == Status.SKIPPED && failure != null
            ? FailureAnalysis.classify(
                "testng",
                status == Status.CONFIGURATION_FAILED ? "configuration" : "test",
                status == Status.CONFIGURATION_FAILED
                    ? com.codinglair.taf.runtime.core.failure.FailureContext.Boundary.AUTOMATION
                    : com.codinglair.taf.runtime.core.failure.FailureContext.Boundary.UNKNOWN,
                failure)
            : null);
  }
