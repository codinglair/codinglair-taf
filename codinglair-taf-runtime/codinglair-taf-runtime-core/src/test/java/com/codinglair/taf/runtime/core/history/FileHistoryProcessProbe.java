  ...
  public static void main(String[] arguments) {
    ...
    var summary =
        new ExecutionAttemptSummary(
            ...
            new FailureSignature("failure-signature:v1:" + "c".repeat(64), "v1"),
            Duration.ofMillis(1),
            "build",
            "local");
    if (new FileExecutionHistoryRepository(configuration).record(summary).status()
        != HistoryResult.Status.SUCCESS) System.exit(2);
  }
}
